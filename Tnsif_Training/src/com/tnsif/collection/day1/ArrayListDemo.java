...
package com.tnsif.collection.day1;
...
public class ArrayListDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Element removed : " + list1.remove(list1.lastIndexOf(20))); // remove last 20
        System.out.println("Element removed : " + list1.remove(list1.indexOf(20)));     // remove first 20
        System.out.println("List is " + list1);
        ...
        System.out.println("Is 'Ethan' contains in name list? " + names.contains("Ethan"));
